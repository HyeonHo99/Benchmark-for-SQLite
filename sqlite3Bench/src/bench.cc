...
void Benchmark::benchmark_run() {
  ...
  while (benchmarks != NULL) {
    ...
    else if (!strcmp(name, "directfillseq")) {
      benchmark_directFillSeq(num_);
    }
    else if (!strcmp(name, "updateuniform")) {
      benchmark_updateUniform(num_);
    }
    else if (!strcmp(name, "filldeleteuniform")) {
      benchmark_fillDeleteUniform(num_);
    }
